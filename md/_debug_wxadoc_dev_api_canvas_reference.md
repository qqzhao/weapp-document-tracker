...
<td>[createCanvasContext](create-canvas-context.html)</td>

<td>创建 canvas 绘图上下文(指定 canvasId)</td>

</tr>

<tr>

<td>[createContext](create-context.html)(不推荐使用)</td>

<td>创建 canvas 绘图上下文</td>

</tr>

<tr>

<td>[drawCanvas](draw-canvas.html)(不推荐使用)</td>
...
<td>[canvasToTempFilePath](temp-file.html)</td>
...
<td>[setFillStyle](set-fill-style.html)</td>
...
<td>[setStrokeStyle](set-stroke-style.html)</td>
...
<td>[setShadow](set-shadow.html)</td>
...
<td>[createLinearGradient](create-linear-gradient.html)</td>
...
<td>[createCircularGradient](create-circular-gradient.html)</td>
...
<td>[addColorStop](add-color-stop.html)</td>

<td>在渐变中的某一点添加一个颜色变化</td>
...
<td>[setLineWidth](set-line-width.html)</td>
...
<td>[setLineCap](set-line-cap.html)</td>
...
<td>[setLineJoin](set-line-join.html)</td>
...
<td>[setMiterLimit](set-miter-limit.html)</td>
...
<td>[strokeRect](stroke-rect.html)</td>
...
<td>[clearRect](clear-rect.html)</td>
...
<td>[beginPath](begin-path.html)</td>
...
<td>[closePath](close-path.html)</td>
...
<td>[quadraticCurveTo](quadratic-curve-to.html)</td>
...
<td>[bezierCurveTo](bezier-curve-to.html)</td>
...
<td>[translate](translate.html)</td>
...
<td>[setFontSize](set-font-size.html)</td>
...
<td>[setTextBaseline](set-text-baseline.html)</td>
...
<td>[setTextAlign](set-text-align.html)</td>
...
<td>[drawImage](draw-image.html)</td>
...
<td>[setGlobalAlpha](set-global-alpha.html)</td>
...
<td>[save](save-restore.html#save)</td>
...
<td>[restore](save-restore.html#restore)</td>
...
<td>[getActions](get-actions.html)(不推荐使用)</td>

<td>获取当前`context`上存储的绘图动作</td>

</tr>

<tr>

<td>[clearActions](clear-actions.html)(不推荐使用)</td>
