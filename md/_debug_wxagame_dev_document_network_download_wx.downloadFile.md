...
*   [网络](wx.downloadFile.html)
    *   [下载](wx.downloadFile.html)
        *   [wx.downloadFile](wx.downloadFile.html)
        *   [DownloadTask](DownloadTask.html)
        *   [DownloadTask.abort](DownloadTask.abort.html)
        *   [DownloadTask.onProgressUpdate](DownloadTask.onProgressUpdate.html)
    ...
    *   [WebSocket](../websocket/wx.connectSocket.html)
        *   [wx.connectSocket](../websocket/wx.connectSocket.html)
        *   [wx.closeSocket](../websocket/wx.closeSocket.html)
        *   [wx.onSocketOpen](../websocket/wx.onSocketOpen.html)
        *   [wx.onSocketClose](../websocket/wx.onSocketClose.html)
        *   [wx.onSocketMessage](../websocket/wx.onSocketMessage.html)
        *   [wx.onSocketError](../websocket/wx.onSocketError.html)
        *   [wx.sendSocketMessage](../websocket/wx.sendSocketMessage.html)
        *   [SocketTask](../websocket/SocketTask.html)
        *   [SocketTask.close](../websocket/SocketTask.close.html)
        *   [SocketTask.onOpen](../websocket/SocketTask.onOpen.html)
        *   [SocketTask.onClose](../websocket/SocketTask.onClose.html)
        *   [SocketTask.onError](../websocket/SocketTask.onError.html)
        *   [SocketTask.onMessage](../websocket/SocketTask.onMessage.html)
        *   [SocketTask.send](../websocket/SocketTask.send.html)
...
<td>临时文件路径。如果没传入 filePath 指定文件存储路径，则下载后的文件会存储到一个临时文件</td>
...
[](../../location/wx.getLocation.html)[](wx.downloadFile.html)</div>
