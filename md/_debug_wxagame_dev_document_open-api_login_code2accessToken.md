...
*   [开放接口](wx.checkSession.html)
    *   [登录](wx.checkSession.html)
        *   [wx.checkSession](wx.checkSession.html)
        *   [wx.login](wx.login.html)
        *   [code2accessToken](code2accessToken.html)
...
<td>用户在开放平台的唯一标识符，只有小程序在满足 UnionID 下发条件的情况下会返回，具体参看 [UinionID 机制说明](https://mp.weixin.qq.com/debug/wxadoc/dev/api/uinionID.html)，小游戏不会返回。</td>
...
[](wx.login.html)[](../authorize/wx.authorize.html)</div>
