...
*   [Worker](wx.createWorker.html)
    *   [wx.createWorker](wx.createWorker.html)
    *   [Worker](Worker.html)
    *   [Worker.onMessage](Worker.onMessage.html)
    *   [Worker.postMessage](Worker.postMessage.html)
...
创建一个 Worker 线程，目前限制最多只能创建一个 Worker，创建下一个 Worker 前请调用 [Worker.terminate](Worker.terminate.html)
...
[](../update/UpdateManager.onUpdateFailed.html)[](wx.createWorker.html)</div>
