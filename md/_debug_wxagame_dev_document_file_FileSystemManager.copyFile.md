...
<td>fail permission denied, copyFile ${srcPath} -> ${destPath}</td>
...
<td>fail no such file or directory, copyFile ${srcPath} -> ${destPath}</td>
...
[](FileSystemManager.accessSync.html)[](FileSystemManager.copyFileSync.html)</div>
