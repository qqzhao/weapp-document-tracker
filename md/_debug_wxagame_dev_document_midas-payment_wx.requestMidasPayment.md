...
<td>支付的类型，不同的支付类型有各自额外要传的附加参数。</td>
...
<td>申请接入时的平台，platform 与应用id有关。</td>
...
<td>购买数量。mode=game 时必填。购买数量。详见 [buyQuantity 限制说明](#buyquantity-限制说明)。</td>
...
<td>虚拟支付接口错误码，客户端错误, 判断到小程序在用户处于支付中时,又发起了一笔支付请求</td>
...
<td>虚拟支付接口错误码，Android 独有错误：用户使用 Google Play 支付，而手机未安装 Google Play</td>
...
[](../timer/setInterval.html)[](wx.requestMidasPayment.html)</div>
