...
获取用户信息，withCredentials 为 true 时需要先调用 [wx.login](../login/wx.login.html) 接口。需要[用户授权](../authorize/wx.authorize.html) scope.userInfo
...
[](../authorize/wx.authorize.html)[](wx.getUserInfo.html)</div>
