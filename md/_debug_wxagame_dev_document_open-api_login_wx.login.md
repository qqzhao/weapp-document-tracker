...
<td>用户登录凭证（有效期五分钟）。开发者需要在开发者服务器后台调用 [code2accessToken](code2accessToken.html)，使用 code 换取 openid 和 session_key 等信息</td>
...
[](wx.checkSession.html)[](code2accessToken.html)</div>
