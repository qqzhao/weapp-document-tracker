...
<td>fail tempFilePath file not exist</td>

<td>指定的 tempFilePath 找不到文件</td>

</tr>

<tr>

<td>fail permission denied, open "${filePath}"</td>
...
[](FileSystemManager.readFileSync.html)[](FileSystemManager.stat.html)</div>
